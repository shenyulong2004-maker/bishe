			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button type="warning" v-if=" btnAuth('jiaoshi','修改')" @click="resetPassClick(scope.row)">重置密码</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
	...
	const resetPassClick = (row) => {
		if (!row || !row.jiaoshigonghao) return
